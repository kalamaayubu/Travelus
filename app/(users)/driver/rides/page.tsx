...
export default async function DriverRidesPage() {
  ...
  return (
    <>
      <div className="flex flex-col min-h-screen text-gray-200 pb-44 md:pb-0">
        <div className="">
              ...
              {rides?.length === 0 ? (
                <div className="flex flex-col items-center justify-center mt-8 p-10 bg-gray-800/80 rounded-lg text-center space-y-6">
                  ...
                  <p className="text-gray-300 max-w-xs">
                    Looks like you haven't created any ride. Start posting your
                    ride to let people join your journey!
                  </p>
                  <AddRideButton />
                </div>
              ) : (
