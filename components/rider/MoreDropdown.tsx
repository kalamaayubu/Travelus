  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="bg-gray-800/90 backdrop-blur-sm rounded-md border p-0 border-white/10">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem
          className="flex items-center gap-3 text-sm text-gray-300 hover:bg-gray-500/30 cursor-pointer rounded-none hover:text-white transition-all duration-300"
        ...
        <DropdownMenuItem
          className="flex items-center  gap-3 text-sm text-gray-300 rounded-none hover:bg-red-500/80 hover:text-white transition-all duration-300"
          onClick={() => {
            dispatch(clearUser());
            logout();
