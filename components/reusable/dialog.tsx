  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent
        ...
        className={`sm:max-w-md z-50 rounded-lg border border-gray-700 bg-white/10 text-gray-100 shadow-lg ${contentClassName ?? ""}`}
      ...
      >
        ...
        {closable && (
          <DialogClose asChild>
            <button className="absolute right-4 top-4 text-gray-00 hover:text-gray-200 bg-transparent outline-none">
              <X className="h-5 w-5" />
            </button>
          </DialogClose>
        )}
