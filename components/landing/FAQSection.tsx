...
const faqs = [
  {
    ...
    answer: `Normal booking systems are built for big bus companies — expensive, complex, and unnecessary if you just have one or two vehicles.
  ...
  },
  {
    ...
    answer:
      "Drop it in the Feedback section below and we’ll get back to you with an answer as soon as possible.",
  },
];
