  ...
  return (
    <footer className="relative bg-gray-950 border-t border-gray-800 py-16">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute -top-24 -left-24 w-[300px] h-[300px] bg-purple-600/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-0 w-[250px] h-[250px] bg-pink-500/20 rounded-full blur-3xl" />
      </div>
